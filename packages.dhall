...
let polyform = mkPackage
  [ "newtype" , "ordered-collections" , "variant" , "profunctor" , "invariant" , "foreign-object" , "run" , "transformers" , "validation" , "foreign" ]
...
in  upstream
  ...
  with
    polyform = polyform
  with
    polyform-batteries-core = polyform-batteries-core
